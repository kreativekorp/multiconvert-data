...
class MBSRMPKernel {
	...
	compile() {
		...
		view.setUint8(1, kptr);
		view.setUint8(2, fptr);
		view.setUint8(3, rptr);
	...
	decompile(view) {
		...
		let kptr = view.getUint8(1, false);
		let fptr = view.getUint8(2, false);
		let rptr = view.getUint8(3, false);
		while (fptr < size) {

...
function cmp(a,b) { return (a < b) ? -1 : (a > b) ? +1 : (a == b) ? 0 : NaN; }
...
module.exports = {
	...
	bitand, bitxor, bitor, and, xor, or, equal,
	ascending, descending, increasing, decreasing, concat, concatsp,
